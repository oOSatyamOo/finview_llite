...
class HoldingListItem extends StatefulWidget {
  ...
  const HoldingListItem({super.key, required this.holding, this.index = 0});
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      mainAxisSize: MainAxisSize
                          .min, // Explicitly tell it to be as small as possible
                      children: [
                        Text(
                      ...
                      children: [
                        ...
                        Obx(() {
                          ...
                          if (controller.returnFormat.value ==
                            ...
                            gainText =
                                '${isPositive ? '+' : '-'}${currencyFormatter.format(widget.holding.totalGain.abs())}';
                          } else {
                            gainText =
                                '${isPositive ? '+' : '-'}${widget.holding.gainPercentage.abs().toStringAsFixed(2)}%';
                          }
